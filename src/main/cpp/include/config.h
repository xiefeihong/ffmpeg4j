...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/ffmpeg-6.1.2 --enable-shared --disable-static"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2024
#define FFMPEG_DATADIR "/usr/local/ffmpeg-6.1.2/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/ffmpeg-6.1.2/share/ffmpeg"
